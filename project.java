...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        JMenuItem t2 = new JMenuItem("Assign Manager");
        ...
        JMenuItem s4= new JMenuItem("Update Department");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        else if(msg.equals("Update Department"))
            new Update_dept().setVisible(true);
