...
public class pay_slip extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ...
            ResultSet rs = c.s.executeQuery("select * from employee,dept where employee.did=dept.did and employee.id="+c1.getSelectedItem());
            rs.next();
            ...
            t1.setText(" ----------------   PAY SLIP FOR THE MONTH OF Jan , 2021  ------------------------");
            t1.append("\n");
            ...
            if(rs.next()){
                ...
                t1.append("\n");    
                t1.append("\n");
                t1.append("   (  Signature: Signature of Admin  )      ");
